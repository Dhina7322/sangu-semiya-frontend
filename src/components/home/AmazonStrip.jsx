...
const AmazonStrip = () => (
  <section className="bg-primary py-12 lg:py-16 overflow-hidden relative group">
    ...
    <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
      ...
      <a href="https://amazon.in" target="_blank" rel="noreferrer" className="bg-white text-primary hover:bg-slate-900 hover:text-white px-12 py-5 rounded-2xl font-medium text-xs uppercase tracking-[0.2em] transition-all duration-500 shadow-xl overflow-hidden relative group shrink-0">
