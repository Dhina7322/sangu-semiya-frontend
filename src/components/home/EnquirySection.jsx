      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
          ...
          <div className="bg-slate-50 p-12 lg:p-20 rounded-[4rem] border border-slate-100 shadow-2xl relative">
            <div className="absolute -top-10 -right-10 w-24 h-24 bg-primary rounded-full flex items-center justify-center text-3xl shadow-2xl text-white font-black animate-bounce rotate-12">⚡</div>
